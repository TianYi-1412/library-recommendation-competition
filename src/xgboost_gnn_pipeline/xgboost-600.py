...
from gnn_feature import EnhancedGNNEmbedder as GNNEmbedder  # 仅新增
...
class PureNewBreakthroughRecommenderV1GNN:
    ...
    def save_recommendations(self):
        ...
        df.to_csv('v0.csv', index=False, encoding='utf-8-sig')
        print(f"✅ 推荐结果已保存为 v0.csv，耗时：{time.time() - start:.2f}秒")
...
if __name__ == "__main__":
    PureNewBreakthroughRecommenderV1GNN.main(
        inter_path='../datasets/inter_final_选手可见.csv',
